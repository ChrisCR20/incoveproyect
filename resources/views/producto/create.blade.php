  ...
  {!! Form::open(array('route' => 'producto.store','method'=>'POST')) !!}
    ...
    <div class="card card-default">
      <div class="card-header">
        <a class="btn btn-primary" id="btnnuevacategoria"><i class="fa fa-plus" aria-hidden="true"></i> Categoria</a>
        <a class="btn btn-secondary" id="btnnuevamarca"><i class="fa fa-plus" aria-hidden="true"></i> Marca</a>
        <a class="btn btn-warning" id="btnnuevamedida"><i class="fa fa-plus" aria-hidden="true"></i> Medida</a>
